...
# ou are given a doubly linked list.
...
class DoublyLinkedList:
    ...
    def swap_pairs(self):
        ...
        while self.head and self.head.next:
            ...
            # 'second_node'. This ensures we don't lose the rest of the list.
            ...
            # Update the 'prev' pointers for both 'first_node' and
            # 'second_node' to maintain the doubly-linked structure
